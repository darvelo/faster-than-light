...
var User, Context, Project, Group, Task;
...
exports.schemas = function (u, c, p, g, t, un) {
  User = u;
  Context = c;
  Project = p;
  Group = g;
    ...
    checkExist: function (callback) {
      User.find({ username : username }, function(err, results) {
        if (err) {
          ...
          return callback(new app.errors.UserExists('Username already exists. Needs to not exist to create stuff.'));
        }
