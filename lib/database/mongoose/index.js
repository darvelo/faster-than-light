...
function seedContexts (cb) {
  var context1 = new Context({
    userId: '515e5387783d657572000001',
    projects: [],
    order: 1,
    title: 'First Context',
...
exports.seedContexts = function (req, res, next) {
  seedContexts(function(err, results) {
    if (err) {
      res.send(err);
    } else {
      res.send(results);
