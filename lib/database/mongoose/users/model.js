...
exports.Schema = function(mongoose) {
  ...
  UserSchema.set('toJSON',
  {
    transform: function (doc, ret, options) {
      // handles case where I had to write [] to db if lastContexts was empty.
      // Mongoose wouldn't let me write an empty {} to MongoDB and kept the old value.
      if (_.isArray(ret.lastContexts)) {
        ret.lastContexts = {};
      }
